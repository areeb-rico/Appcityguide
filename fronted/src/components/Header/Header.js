...
function Header() {
  ...
  APP-CITIGUIDE<span className="text-primary"></span>
</Link>
            ...
            <ul className="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
              ...
              <li>
              <Link to="/listing">Attraction_listings</Link>
              </li>
                   <li>
              <Link to="/maps">Maps & Directions</Link>
              </li>
              
                 <li>
              <Link to="/searchres">Search_results</Link>
              </li>
               <li>
              <Link to="/splash">Splash</Link>
              </li>
                <li>
              <Link to="/profilepref">ProfilePreference</Link>
              </li>
                <li>
              <Link to="/splash">Write Reviews</Link>
              </li>
